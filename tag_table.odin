...
// Tag_Table
    ...
    Tag_Table :: struct {
        ...
        eid_to_ptr: oc_maps.Rh_Map(^entity_id),  // pointer to cell in rid_to_eid
    ...
    tag_table__add_tag :: proc(self: ^Tag_Table, eid: entity_id, loc:= #caller_location) -> (err: Error) {
        ...
        raw := (^runtime.Raw_Slice)(&self.rid_to_eid)
        ...
        // Update rid_to_eid
        #no_bounds_check {
            eidptr = &self.rid_to_eid[raw.len]
        }
    ...
    tag_table__remove_tag :: proc(self: ^Tag_Table, target_eid: entity_id, loc:= #caller_location) -> (err: Error) {
        ...
        tail_rid := raw.len - 1
        tail_ptr := &self.rid_to_eid[tail_rid]
    ...
    tag_table__clear :: proc (self: ^Tag_Table) -> Error {
        ...
        (^runtime.Raw_Slice)(&self.rid_to_eid).len = 0
