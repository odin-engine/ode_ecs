...
///////////////////////////////////////////////////////////////////////////////
    ...
    group__owns_arch_table_only__test :: proc(t: ^testing.T) {
        ...
        ps := ecs.group_dense_slice(&group, &at, Position)
    ...
    group__owns_table_and_arch_table_mixed__test :: proc(t: ^testing.T) {
        ...
        spd_slice := ecs.group_dense_slice(&group, &speeds)
        pos_slice := ecs.group_dense_slice(&group, &at, Position)
        ai_slice := ecs.group_dense_slice(&group, &at, AI)
    ...
    group__arch_table_pause_resume__test :: proc(t: ^testing.T) {
        ...
        testing.expect(t, ecs.group_dense_slice(&group, &at, Position) == nil, "dirty group must report no dense slice")
